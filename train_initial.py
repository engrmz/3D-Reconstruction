...
from tf_dataloader import DataLoader
...
def main(unused_argv):
  ...
  '''loading from generated TFRecords'''
  ...
  with tf.train.MonitoredTrainingSession(
    ...
    while not mon_sess.should_stop():
      ...
      ''' For debuging the loaded data'''
      # a = mon_sess.run(batch)
      # print("{}   {}".format(a['image'].shape, a['image'].dtype))
      # print("{}   {}".format(a['depth'].shape, a['depth'].dtype))
      # print("{}   {}".format(a['point'].shape, a['point'].dtype))
      # print("{}   {}".format(a['point_label'].shape, a['point_label'].dtype))
      # print("{}   {}".format(a['name'].shape, a['name'].dtype))

      # Image => (16, 224, 224, 3)       dtype=float32
      # Depth => (16, 224, 224, 20)      dtype=float32
